package com.cloud.common.util.file;
...
public class FileTool {
    ...
    public static final String getRawString(int rawId) {
        final InputStream is = ((Context) Cloud9.getConfig(ConfigurationKey.APPLICATION_CONTEXT)).getResources().openRawResource(rawId);
